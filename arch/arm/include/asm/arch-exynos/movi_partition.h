...
#endif
#define PART_SIZE_DTB		(256 * 1024)
#define PART_SIZE_XEN		(1 * 1024 * 1024)
...
#define MOVI_DTB_BLKCNT		(PART_SIZE_DTB / MOVI_BLKSIZE)		/* 256KB */
#define MOVI_XEN_BLKCNT		(PART_SIZE_XEN / MOVI_BLKSIZE)		/* 1MB */
