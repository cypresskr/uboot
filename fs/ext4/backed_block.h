...
typedef void (*data_block_callback_t)(block_dev_desc_t *dev_desc, disk_partition_t* part, u64 off, u8 *data, int len);
typedef void (*data_block_fill_callback_t)(block_dev_desc_t *dev_desc, disk_partition_t* part, u64 off, u32 fill_val, int len);
